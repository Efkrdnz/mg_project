...
import net.mcreator.minefinitygauntlet.procedures.ScreenShakeOnEffectActiveTickProcedure;
...
public class ScreenShakeMobEffect extends MobEffect {
	...
	public boolean applyEffectTick(LivingEntity entity, int amplifier) {
		ScreenShakeOnEffectActiveTickProcedure.execute(entity);
	...
	public static void registerMobEffectExtensions(RegisterClientExtensionsEvent event) {
		...
		}, MinefinityGauntletModMobEffects.SCREEN_SHAKE.get());
	}
}
