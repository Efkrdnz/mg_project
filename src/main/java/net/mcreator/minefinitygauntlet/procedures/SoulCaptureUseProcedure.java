...
public class SoulCaptureUseProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		for (int index0 = 0; index0 < 50; index0++) {
			if (!((world.getBlockState(BlockPos.containing(entity.getX() + raytrace_distance * entity.getLookAngle().x, entity.getY() + 1.4 + raytrace_distance * entity.getLookAngle().y, entity.getZ() + raytrace_distance * entity.getLookAngle().z)))
					.getBlock() == Blocks.AIR)) {
				if (world instanceof ServerLevel _level)
					_level.sendParticles((SimpleParticleType) (MinefinityGauntletModParticleTypes.POWER_EXP_1.get()), (entity.getX() + raytrace_distance * entity.getLookAngle().x), (entity.getY() + 1.4 + raytrace_distance * entity.getLookAngle().y),
							(entity.getZ() + raytrace_distance * entity.getLookAngle().z), 1, 0.2, 0.2, 0.2, 0);
				break;
			}
			if (!world
					.getEntitiesOfClass(LivingEntity.class,
							...
							e -> true)
					.isEmpty()
					&& !(((Entity) world.getEntitiesOfClass(LivingEntity.class, AABB
							.ofSize(new Vec3((entity.getX() + raytrace_distance * entity.getLookAngle().x), (entity.getY() + 1.6 + raytrace_distance * entity.getLookAngle().y), (entity.getZ() + raytrace_distance * entity.getLookAngle().z)), 1, 1, 1),
				...
				if (!(((Entity) world.getEntitiesOfClass(LivingEntity.class,
						AABB.ofSize(new Vec3((entity.getX() + raytrace_distance * entity.getLookAngle().x), (entity.getY() + 1.4 + raytrace_distance * entity.getLookAngle().y), (entity.getZ() + raytrace_distance * entity.getLookAngle().z)), 1, 1, 1),
						e -> true).stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
							}
						}.compareDistOf((entity.getX() + raytrace_distance * entity.getLookAngle().x), (entity.getY() + 1.4 + raytrace_distance * entity.getLookAngle().y), (entity.getZ() + raytrace_distance * entity.getLookAngle().z))).findFirst()
						.orElse(null)) == (null))) {
					...
					if (!(ent == null)) {
						SoulCaptureSystemProcedure.captureEntity(entity, ent);
						break;
					}
				}
			} else {
