...
public class SelectAbilityOnKeyPressedProcedure {
			...
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					...
					public Component getDisplayName() {
						return Component.literal("SelectAbilitySpace");
					}
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						return new SelectAbilitySpaceMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
		...
		if (entity.getData(MinefinityGauntletModVariables.PLAYER_VARIABLES).SelectedStone == 2) {
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					@Override
					public Component getDisplayName() {
						return Component.literal("SelectAbilityReality");
					}
					...
					@Override
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						return new SelectAbilityRealityMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
		if (entity.getData(MinefinityGauntletModVariables.PLAYER_VARIABLES).SelectedStone == 3) {
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					@Override
					public Component getDisplayName() {
						return Component.literal("SelectAbilityTime");
					}
					...
					@Override
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						return new SelectAbilityTimeMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
		if (entity.getData(MinefinityGauntletModVariables.PLAYER_VARIABLES).SelectedStone == 4) {
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					@Override
					public Component getDisplayName() {
						return Component.literal("SelectAbilitySoul");
					}
					...
					@Override
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						return new SelectAbilitySoulMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
		if (entity.getData(MinefinityGauntletModVariables.PLAYER_VARIABLES).SelectedStone == 5) {
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					@Override
					public Component getDisplayName() {
						return Component.literal("SelectAbilityMind");
					}
